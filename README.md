...
This is an investigation, not a product. **Milestone 1** (rules classifier, stock shares, gold labels, raw and corrected headlines) is in the repo. Corrected shares use the held-out test split only.
