...
CASES: list[tuple[str, str, BuildingType | None, OwnerClass]] = [
    ...
    ("R020_public", "CITY OF PHILADELPHIA", None, OwnerClass.PUBLIC),
    ("R020_public", "PHILADELPHIA HOUSING AUTH", None, OwnerClass.PUBLIC),
    ("R020_public", "CITY OF CHICAGO", None, OwnerClass.PUBLIC),
    ("R020_public", "COOK COUNTY", None, OwnerClass.PUBLIC),
    ("R020_public", "MIAMI-DADE COUNTY", None, OwnerClass.PUBLIC),
    ("R020_public", "CITY OF MIAMI", None, OwnerClass.PUBLIC),
    ("R021_placeholder_owner", "TAXPAYER OF", None, OwnerClass.UNKNOWN),
    ("R021_placeholder_owner", "CURRENT OWNER", None, OwnerClass.UNKNOWN),
...
NEGATIVES: list[tuple[str, str, BuildingType | None]] = [
    ...
    ("R020_public", "PHILADELPHIA HOME RENTALS LLC", BuildingType.SFR_1_4),
    ("R020_public", "MIAMI LLC", BuildingType.SFR_1_4),
    ("R021_placeholder_owner", "JOHN SMITH", None),
